            ...
            >
              ...
              {item.icon?.asset?.url && (
                <div className="mx-auto mb-8 flex justify-center">
                  <div className="relative w-24 h-24 rounded-3xl bg-[#311d60]/20 shadow-[0_10px_30px_rgba(49,29,96,0.15)] flex items-center justify-center group-hover:bg-[#311d60]/30 transition">
