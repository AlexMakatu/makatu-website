...
export default function Hero({ homepage, logo }: HeroProps) {
  return (
    <section className="relative overflow-hidden bg-[#311d60] text-white min-h-[75vh] md:min-h-[90vh] flex items-center">
      {/* Background Image */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-24 w-full">
        <div className="max-w-xl">
          ...
          >
            <Link
              href="/get-a-quote"
              className="bg-white text-[#311d60] px-8 py-4 rounded-lg font-semibold text-center hover:scale-105 transition"
            >
              Get a Quote
            </Link>
            ...
            <Link
              ...
              className="border border-white px-8 py-4 rounded-lg text-center hover:bg-white hover:text-[#311d60] transition"
            >
              View Routes
            </Link>
          </motion.div>
