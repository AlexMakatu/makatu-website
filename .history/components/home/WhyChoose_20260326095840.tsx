              ...
              {item.icon?.asset?.url && (
                <div className="mb-8 flex justify-center">
                  <div className="relative">
                    ...
                    {/* icon container */}
                    <div className="relative w-30 h-30 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full bg-white shadow-lg flex items-center justify-center border border-gray-100">
                      <div className="relative w-25 h-25 sm:w-14 sm:h-14 md:w-16 md:h-16">
                        <Image
