...
import HomeRouteEstimator from "@/components/HomeRouteEstimator";
...
export default function Hero({ homepage, logo }: HeroProps) {
  return (
    <section className="relative overflow-hidden bg-[#311d60] text-white min-h-[80vh] md:min-h-[95vh] flex items-center">
      {/* Background Image */}
      ...
      {/* Bottom Fade (premium transition) */}
