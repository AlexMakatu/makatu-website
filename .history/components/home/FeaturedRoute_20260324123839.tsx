    ...
    <section className="py-24 bg-gray-100 border-b border-gray-200 overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="relative mb-10 text-center">
          {/* BACKGROUND WORD */}
          <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-[90px] md:text-[160px] font-extrabold text-#311d60-300 opacity-30 leading-none pointer-events-none select-none">
            TRANSPORT
          </span>
