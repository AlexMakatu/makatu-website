        ...
        if (section._type === "ctaSection") {
          return (
            <div key={section._key} className="my-20 px-6">
              <div className="max-w-4xl mx-auto bg-gradient-to-br from-purple via-gray-900 to-purple text-white rounded-3xl p-10 md:p-14 text-center shadow-2xl border border-gray-800">
                {section.heading && (
