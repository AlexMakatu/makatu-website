        ...
        switch (section._type) {
          ...
          case "textSection":
            ...
            if (section.sectionKey === "internalLinks" && section.content) {
              ...
              const routes =
                text.match(/\/vehicle-transport\/[a-z0-9\-]+/gi) || [];
            ...
            // ❗ DEFAULT (all other text sections)
            return section.content ? (
              <div key={section._key}>
                <PortableText
                  value={section.content}
                  components={portableTextComponents} // ✅ REQUIRED
                />
              </div>
            ) : null;
          /* ---------- IMAGE ---------- */
