...
export default function FloatingCTA({
  ...
  return (
    <>
      {/* Desktop */}
      {/* Desktop */}
      <div className="hidden md:flex flex-col items-end gap-3 fixed top-1/2 -translate-y-1/2 right-6 z-50">
        <Link
          href={quoteUrl}
          className="bg-[#311d60] text-white px-6 py-4 rounded-xl shadow-xl font-semibold hover:scale-105 transition text-base"
        >
          Get a Quote
        </Link>
        ...
        <a
          href={whatsappUrl}
          target="_blank"
          className="text-sm text-gray-700 bg-white px-4 py-2 rounded-lg shadow hover:bg-gray-50"
        >
          💬 Talk to an agent
        </a>
      </div>
