...
export default async function ReviewsPage() {
  ...
  return (
    <section className="py-24 bg-gray-50">
      <div
        key={review._id}
        className="relative bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg transition p-8 flex flex-col"
      >
        {/* Quote icon */}
        <div className="absolute top-6 right-6 text-gray-100 text-6xl leading-none select-none">
          "
        </div>
