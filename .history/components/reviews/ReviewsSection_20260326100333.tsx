        ...
        <div className="relative text-center mb-12 sm:mb-14">
          ...
          <span
            className="
              ...
              text-[50px] sm:text-[70px] md:text-[140px] 
          ...
          {/* TITLE */}
          <h2 className="relative text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 leading-tight">
          ...
          {reviews.map((review) => (
            <div
              ...
              className="
                ...
                shadow-sm 
                transition 
                hover:shadow-[0_20px_50px_rgba(49,29,96,0.08)]
                p-5 sm:p-6 md:p-8 
                flex flex-col
              "
            >
              ...
              <div className="flex items-center justify-between mb-5 sm:mb-6">
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  <img
                    ...
                    alt={review.source}
                    className="h-6 sm:h-7 md:h-8 w-auto object-contain opacity-80 grayscale hover:grayscale-0 transition"
                  />
                ...
                {review.source === "wisemove" ? (
                  ...
                  <span className="text-yellow-500 text-base sm:text-lg whitespace-nowrap">
