...
export default async function Footer() {
  ...
  return (
    <footer className="mt-24 text-white bg-[linear-gradient(180deg,#311d60_0%,#2a1854_60%,#1f113f_100%)]">
      {/* TRANSPORT STATS */}

      <div className="border-b border-white/5">
        <div className="max-w-6xl mx-auto px-6 py-10 grid md:grid-cols-2 gap-10 text-center md:text-left">
          <div>
            ...
            <p className="text-4xl font-semibold mt-2">
              Nationwide
              <span className="text-lg ml-2 text-purple-200">Coverage</span>
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-4xl font-semibold mt-2">
              Door-to-Door
              <span className="text-lg ml-2 text-purple-200">Transport</span>
            </p>
          </div>
        </div>
      </div>
