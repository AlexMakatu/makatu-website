  ...
  return (
    <main className="flex flex-col">
      ...
      <div className="flex justify-center py-6">
        <div className="w-16 h-[2px] bg-[#311d60]/20 rounded-full" />
      </div>
      {/* SEO INTRO */}
      {homepage?.seoIntro && (
        <section className="py-24 bg-white border-b border-gray-200 overflow-hidden">
          <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              {/* BIG BACKGROUND WORD */}
              <span className="absolute -top-16 left-0 text-[90px] md:text-[140px] font-extrabold text-gray-200 opacity-40 leading-none pointer-events-none select-none">
                NATIONWIDE
              </span>
