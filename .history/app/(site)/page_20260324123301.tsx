        ...
        <section className="py-24 bg-white border-t border-gray-200 overflow-hidden">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="relative mb-10">
              {/* BACKGROUND WORD */}
              <span className="absolute left-0 top-1/2 -translate-y-1/2 text-[90px] md:text-[160px] font-extrabold text-gray-300 opacity-30 leading-none pointer-events-none select-none">
                NATIONWIDE
              </span>
