  ...
  return (
    <main>
      ...
      <section className="relative min-h-[55vh] flex items-center justify-center text-white text-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 py-24 md:py-10">
      ...
      {/* CTA */}
      <section className="bg-[#311d60] text-white py-24 mt-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-white/80 max-w-xl mx-auto mb-10 text-lg">
            Secure and reliable vehicle transport between {fromCity} and{" "}
            {toCity}. Request a fast quote and our logistics team will assist
            with scheduling your vehicle shipment.
          </p>

          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              href="/get-a-quote"
              className="bg-white text-[#311d60] px-10 py-4 rounded-xl font-semibold hover:scale-105 transition"
            >
              Get Instant Quote
            </Link>
            ...
            <Link
              href="/contact"
              className="border border-white px-10 py-4 rounded-xl font-semibold hover:bg-white hover:text-[#311d60] transition"
            >
              Speak to Our Team
            </Link>
          </div>
