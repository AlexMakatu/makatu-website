      ...
      <section class="mb-20">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div class="bg-white border rounded-lg p-6">
            <h3 class="font-semibold mb-2">Private Vehicle Owners</h3>
            <p class="text-gray-600">
              Individuals relocating, buying vehicles online, or transporting
              cars between cities rely on Makatu for safe nationwide vehicle
              delivery.
            </p>
          </div>

          <div class="bg-white border rounded-lg p-6">
            <h3 class="font-semibold mb-2">Vehicle Dealerships</h3>
            <p class="text-gray-600">
              Dealerships use Makatu to move stock between branches and deliver
              vehicles to customers across South Africa.
            </p>
          </div>

          <div class="bg-white border rounded-lg p-6">
            <h3 class="font-semibold mb-2">Auction Buyers</h3>
            <p class="text-gray-600">
              Buyers who purchase vehicles at auctions require reliable
              transport services to move vehicles from auction locations to
              their destination.
            </p>
          </div>

          <div class="bg-white border rounded-lg p-6">
            <h3 class="font-semibold mb-2">Relocation Companies</h3>
            <p class="text-gray-600">
              Relocation companies partner with Makatu to move client vehicles
              during household and corporate relocations.
            </p>
          </div>

          <div class="bg-white border rounded-lg p-6">
            <h3 class="font-semibold mb-2">Fleet Operators</h3>
            <p class="text-gray-600">
              Businesses operating vehicle fleets use Makatu to relocate
              vehicles between branches, offices and operational sites.
            </p>
          </div>

          <div class="bg-white border rounded-lg p-6">
            <h3 class="font-semibold mb-2">OEM Manufacturers</h3>
            <p class="text-gray-600">
              Automotive manufacturers and distributor networks use professional
              vehicle transport services to move vehicles between production,
              storage and dealership locations.
            </p>
          </div>
        </div>
      </section>
